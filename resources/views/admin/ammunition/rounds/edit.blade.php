                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">                                                
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <form name="brand_frm" id="brand_frm" method="post" action="{{route('admin_ammunition_rounds_edit')}}">
                                                            @csrf
                                                            <div class="form-group">
                                                                <label>Rounds</label>
                                                                <input type="Number" class="form-control required" placeholder="Enter Rounds" name="value" value="<?php echo (!empty($result['value']))?$result['value']:"";?>"/>
                                                            </div>
